...
public class Board implements Serializable {
     ...
     * @param horizontal Se verdadeiro, estende para a direita (X aumenta). Falso, estende para baixo (Y aumenta).
     * @return true se foi possível colocar o navio, false caso contrário (sobreposição ou fora dos limites).
     */
     ...
     * @return O resultado do tiro ("AGUA", "ACERTOU_EM <TIPO>", "AFUNDOU <TIPO>", ou null se já havia sido atingido).
     */
    public String receiveShot(int x, int y) {
        ...
        if (cell.getState() == Cell.CellState.HIT || cell.getState() == Cell.CellState.MISS || cell.getState() == Cell.CellState.SUNK) {
